...
namespace app\modules\minislider\controllers\backend;

use app\modules\minislider\models\MiniSlider;
use app\modules\minislider\models\MiniSliderSearch;
use Yii;
...
class DefaultController extends BackendController
{
    ...
    {
        $newModel = new MiniSlider();
        $searchModel = new MiniSliderSearch();
    ...
    {
    	//echo '<pre>'.print_r(Yii::$app->request->post(),1).'</pre>'; exit;
    ...
    {
        if (($model = MiniSlider::findOne($id)) !== null) {
            return $model;
        } else {
            return false;
        }
